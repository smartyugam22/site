...
import logo from '../assets/img_logo.jpeg';
    ...
    <nav className={`header-nav ${isScrolled ? 'scrolled' : ''}`}>
      ...
      <style jsx>{`
        .header-nav {
          ...
          height: 80px; transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
        ...
        .nav-logo img { height: 48px; width: auto; transition: .3s; }
        .header-nav.scrolled .nav-logo img { height: 40px; }
        .nav-logo-text { font-family: 'Playfair Display', serif; font-size: 1.15rem; font-weight: 800; color: var(--maroon); line-height: 1.1; }
        .nav-logo-text span { display: block; font-size: .6rem; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 750; color: var(--gold); letter-spacing: 1.5px; margin-top: 2px; text-transform: uppercase; }
        
        .nav-links-desktop { display: flex; gap: 2.2rem; list-style: none; margin: 0 2rem; }
        .nav-links-desktop a { 
        ...
        .nav-cta { 
          background: var(--maroon); color: white; padding: 0.75rem 1.6rem; 
          border-radius: 50px; text-decoration: none; font-weight: 800; 
          font-size: 0.85rem; transition: 0.4s; display: flex; align-items: center; gap: 0.8rem;
          box-shadow: 0 8px 25px rgba(139,28,61,0.2);
        }
        .nav-cta:hover { background: var(--maroon-dark); transform: translateY(-2px); box-shadow: 0 12px 30px rgba(139,28,61,0.3); }
        ...
        .mobile-cta { 
          background: var(--maroon); color: white; padding: 1rem; 
