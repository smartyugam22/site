  ...
  return (
    <div className="hof-page" style={{ marginTop: '70px' }}>
      <section className="hof-hero">
        ...
        >
          <div className="hof-badge"><Trophy size={20} /><span>Hall of Fame</span></div>
      ...
      <style jsx>{`
        ...
        .hof-hero { padding: 120px 5% 80px; background: linear-gradient(135deg, #2a0812 0%, #1a1a2e 100%); color: white; text-align: center; }
        ...
        .hof-title { font-family: 'Playfair Display', serif; font-size: clamp(2.5rem, 6vw, 4.5rem); line-height: 1.1; margin-bottom: 1.5rem; }
        .hof-subtitle { max-width: 700px; margin: 0 auto; font-size: 1.1rem; opacity: 0.8; line-height: 1.7; font-weight: 500; }

        .hof-grid-section { padding: 100px 5%; background: #fdfaf7; }
        .hof-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 3rem; max-width: 1400px; margin: 0 auto; }
        
        .hof-card { background: white; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.05); transition: 0.5s; cursor: pointer; }
        ...
        .hof-card-footer { border-top: 1px solid rgba(0,0,0,0.05); padding-top: 1.2rem; display: flex; align-items: center; gap: 0.6rem; color: #4db8a0; font-weight: 700; font-size: 0.8rem; }
