  ...
  return (
    <div className="events-page" style={{ marginTop: '70px' }}>
      ...
      <style jsx>{`
        ...
        .event-card { background: white; border-radius: 24px; overflow: hidden; box-shadow: 0 15px 40px rgba(0,0,0,0.05); transition: 0.4s; }
        ...
        .book-btn { width: 100%; background: var(--maroon); color: white; border: none; padding: 1rem; border-radius: 12px; font-weight: 800; font-size: 0.9rem; cursor: pointer; transition: 0.3s; display: flex; align-items: center; justify-content: center; gap: 0.8rem; }
