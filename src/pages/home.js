    ...
    <div className="home-page">
      ...
      <style jsx>{`
        ...
        .link-button:hover { 
          ...
          box-shadow: 0 15px 50px rgba(139,28,61,0.4); 
          padding-right: 3rem;
        }

        .why { padding: 120px 5%; background: var(--white); }
        .why-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 3rem; margin-top: 4rem; }
        .why-col { 
          background: #fff; 
        ...
        .why-check { color: var(--maroon); flex-shrink: 0; margin-top: 2px; }
        .why-item span { font-size: 0.95rem; color: var(--text-light); font-weight: 600; line-height: 1.5; }

        .records { padding: 120px 5%; background: #fdfaf7; }
