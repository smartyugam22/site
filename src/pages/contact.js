  ...
  return (
    <section className="contact" id="contact" style={{ marginTop: '70px' }}>
        ...
        >
          ...
          <div className="contact-mission-badge">
            ...
            <div className="mission-text">
              <h4>ISO 9001:2015 Certified Vision</h4>
              <p>Smart Yugam Academy is committed to making world-class cognitive education accessible through quality-driven institutional frameworks.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="contact-form">
            <div className="form-header">
              ...
              <p>Fill out the form and our pedagogical experts will reach out to schedule a diagnostic session for your learner.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <select required>
                  <option value="">Select a specialized program...</option>
                  <option value="robotics">Robotics & STEM</option>
                  <option value="abacus">Abacus (Junior/Senior)</option>
                  <option value="vedic">Vedic Mathematics</option>
                  <option value="rubiks">Rubik's Cube Mastery</option>
                  <option value="mid-brain">Mid Brain Activation</option>
                  <option value="chess">Chess Training</option>
                  <option value="phonics">Phonics & Handwriting</option>
                  <option value="speaking">Public Speaking & Communication</option>
                  <option value="hindi">Hindi Writing & Speaking</option>
                  <option value="partnership">School/Institutional Partnership</option>
                </select>
              </div>
              <div className="form-group">
                <label>Message / Specific Goals</label>
      ...
      <style jsx>{`
        ...
        .form-title-icon { color: var(--gold); }
        .form-header h3 { font-family: 'Playfair Display', serif; font-size: 2.2rem; font-weight: 700; color: var(--maroon); }
        .form-header p { color: var(--text-light); font-size: 1rem; font-weight: 500; line-height: 1.6; }

        .form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem; }
        .form-group { margin-bottom: 1.5rem; }
        .form-group label { display: block; font-size: 0.82rem; font-weight: 800; color: var(--maroon); margin-bottom: 0.6rem; text-transform: uppercase; letter-spacing: 1px; }
        ...
        .form-group input:focus, .form-group select:focus, .form-group textarea:focus { border-color: var(--maroon); background: white; box-shadow: 0 0 0 4px rgba(139, 28, 61, 0.05); }
        ...
        .form-submit:hover { transform: translateY(-3px); box-shadow: 0 20px 50px rgba(139, 28, 61, 0.45); }
